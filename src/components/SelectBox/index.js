        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#3be6af",
              "&:hover": { backgroundColor: "#3be6af", color: "#ffffff" },
            }),
