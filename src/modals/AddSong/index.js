...
import { createSong, uploadFile, addNewRelease, fetchCategory, URL } from "Service/api";
...
const AddSongModal = (props) => {
  ...
  const form = useForm({ name: "", categoryId: "", fileType: null, filePath: "", artwork: null, tosAccepted: true, thanksNote: "", basePrice: 500 },
    {
      validate: true,
  ...
  async function callCreateSongApi(data) {
    ...
    await createSong(req)
      ...
      .then((song) => {
        ...
        let release = {
          data: { "songId": song.id, "type": "1" }
        };
        console.log(release);
        addNewRelease(release);
        props.onRequestClose(song);
      })
      .catch((err) => {
        console.error(err);
        toast.error("Try again later.");
  ...
  function callCreateSongResetApi(data) {
            ...
            <Column className="bg-white_A700 items-center px-[20px] w-full">
                ...
                <div className="w-4/12">
                  <Column className="w-[127px] mt-[20px]">
                    ...
                    <Row className="flex flex-row justify-between w-full">
                      ...
                      <input hidden={true} name="artwork" ref={previewRef} onChange={handlePreviewUpload} accept="image/*" type="file" autoComplete="off" tabIndex="-1" />
                ...
                <Column className=" w-8/12">
                  ...
                  <Column className="mb-[15px] w-[100%]">
                    ...
                    <Input
                      ...
                      name="basePrice"
                      onChange={(e) => {
                        form.handleChange("basePrice", parseFloat(e.target.value));
                      }}
              ...
              <Row className="items-end mb-[15px]  w-full">
                <Column className="md:w-6/12">
                  ...
                  <input hidden={true} required={true} accept=".mp3,audio/*" ref={fileRef} type="file" autoComplete="off" tabIndex="-1" onChange={handleFileUpload} name="filePath" />
              ...
              <Line className="bg-bluegray_900 h-[1px] mt-[10px] w-[100%]" />
              <Row className="items-center justify-between w-full py-[10px]">
                <Button
                ...
                <Row className="justify-between">
                  ...
                  <Button
                    className="common-pointer font-semibold text-[15px] text-center ml-[20px] w-[200px]"
                    onClick={() => {
                      form.handleSubmit(callCreateSongResetApi);
                    }}
                    shape="RoundedBorder5"
                    size="sm"
