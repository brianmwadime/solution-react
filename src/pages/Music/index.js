...
import { fetchSongs, fetchAlbums, deleteAlbum, deleteSong } from "Service/api";
                                    ...
                                    <React.Fragment
                                      ...
                                      {<tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td className="py-4 px-6">
                                          <Img
                                            src={isValidUrl(song?.artwork) ? song?.artwork : "images/noImage.svg"}
                                            className="w-[50px]"
                                            alt="avatar"
                                          />
                                        </td>
                                  ...
                                  return (
                                    <React.Fragment
                                      ...
                                      {<tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td className="py-4 px-6">
                                          <Img
                                            src={isValidUrl(album?.artwork) ? album?.artwork : "images/noImage.svg"}
                                            className="w-[50px]"
                                            alt="avatar" />
                                        </td>
                                        <td className="py-4 px-6">
