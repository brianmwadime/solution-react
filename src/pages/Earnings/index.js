...
import { Column, Row, Img, Text, Button, List, SideBar, SearchBar } from "Components";
import NoContent from "Components/NoContent";
import usePageTitle from "Hooks/usePageTitle.js";

const EarningsPage = () => {
  usePageTitle("Solution - Earnings");
  ...
  const [searchTerm, setInputvalue] = React.useState("");

  return (
    <>
      <div className="bg-white_A700 font-poppins  min-h-screen">
        <Row className="flex-grow flex-row min-h-[50vh]">
          <SideBar pageTitle="Earnings" />
          <div className="w-full max-w-screen px-12 md:px-12 my-6">
            <header className="w-[99%]">
              <SearchBar pageTitle="Earnings" searchTerm={searchTerm} setSearchTerm={setInputvalue} />
            </header>
            <main id="main" className="flex flex-col space-y-3 items-start flex-grow">
              <div className="bg-gray_50 justify-center mt-[20px] p-[26px] rounded-radius12 w-[100%]">
                <div className="flex flex-row items-end mb-[64px] w-[auto]">
                  <div className="xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[9px] w-auto">
                    ...
                    <div
                      ...
                      <Row className="ml-[auto] mr-[auto] mt-[15px]">
                  ...
                  <List
                    className="gap-[20px] grid grid-cols-3 min-h-[auto] ml-[20px] w-[auto]"
                    orientation="horizontal">
                    <Column
                      className="common-pointer bg-white_A700 items-center p-[20px] rounded-radius22 shadow-bs w-auto"
                      onClick={navigateToWithdraw}>
                      <Button
                        className="flex h-[44px] w-[44px] items-center justify-center rounded-radius50"
                        size="mdIcn"
                      ...
                      <Text className="font-normal mt-[10px] not-italic text-[16px] text-center text-gray_901 w-[auto]">
                        Withdraw to <br />
                        bank
                      </Text>
                    </Column>
                    <Column
                      className="common-pointer bg-white_A700 items-center p-[20px] rounded-radius22 shadow-bs auto"
                      onClick={navigateToWithdraw}>
                      <Button
                        className="flex h-[44px] w-[44px] items-center justify-center rounded-radius50"
                        size="mdIcn"
